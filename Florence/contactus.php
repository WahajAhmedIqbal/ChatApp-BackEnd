        ...
        <div class="contactus">
            <div class="contactus-row">
                <div class="contact-text">
                    <h1>Contacts</h1>
                    <div class="contact-order-txt">
                        <label>GENERAL INQUIRIES:</label>
                        <span> HELLO@FLORENCE.COM</span>
                        <p>(000) 000-0000</p>
                    </div>
                    <div class="contact-order-txt">
                        <label>ONLINE ORDERS:</label>
                        <span>CUSTOMERSERVICE@FLORENCE.COM</span>
                        <p>(000) 000-0000</p>
                    </div>
                    <div class="contact-order-txt">
                        <label>SALES TEAM:</label>
                        <span> SALES@FLORENCE.COM</span>
                        <p>(000) 000-0000</p>
                    </div>
                </div>
                <div class="contact-image">
                    <div class="contact-img">
                        <img src="assets/img/1x/contactimg.png" alt="">
                    </div>
                </div>
            </div>
        </div>
