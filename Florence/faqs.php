    ...
    <div class="main-body">
        <div class="container">
            <div class="terms-condition">
                <div class="top-heading-FAQ">
                    <h1>FAQ</h1>
                </div>
                <div class="FAQ-text mt5">
                    <div class="colas-bordr">
                        <div class="FAQ-txt-exchange">
                            <span>EXCHANGE + RETURN POLICIES</span>
                            <p></p>
                            <a class="" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fas fa-long-arrow-alt-down"></i>
                            </a>
                        </div>
                        <div class="collapse mt1 faq-colapses" id="collapseExample">
                            <div class="card card-body cstm-card-css">
                ...
                <div class="FAQ-text mt3">
                    <div class="colas-bordr">
                        ...
                        <div class="collapse mt1 faq-colapses" id="collapseExample2">
                            <div class="card card-body cstm-card-css">
                ...
                <div class="FAQ-text mt3">
                    <div class="colas-bordr">
                        ...
                        <div class="collapse mt1 faq-colapses" id="collapseExample3">
                            <div class="card card-body cstm-card-css">
                ...
                <div class="FAQ-text mt3">
                    <div class="colas-bordr">
                        ...
                        <div class="collapse mt1 faq-colapses" id="collapseExample4">
                            <div class="card card-body cstm-card-css">
