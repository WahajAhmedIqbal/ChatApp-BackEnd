            ...
            <div class="collection-page">
                <div class="collection-heading">
                    <div class="top-heading">
                        <h1><i>Collections</i></h1>
                    </div>
                </div>
                <div class="row collection-row justify-content-between" >
                    <div class="col-lg-7 mt2">
                        <div class="collection-row-image">
                            <img src="./assets/img/1x/collection1.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 mt2">
                        <div class="collection-row-image">
                            <img src="./assets/img/1x/collection2.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 mt2">
                        <div class="collection-row-text">
                ...
                <!-- <div class="row collection-row mt3">
                    <div class="col-lg-6">
                        <div class="collection-row-image">
                    ...
                    <div class="col-lg-6">
                        <div class="collection-row-text">
                            <h1>Iluminated</h>
                                ...
                                <a href=""><button>EXPLORE THE PRODUCTS</button></a>
                        </div>
                    </div>
