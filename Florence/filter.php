...
<body>
    ...
    <div class="main-body">
        <div class="container">
            <div class="page-top mt2">
                <div class="dropdown">
                    <button class="btn dropdown-toggle cstm-drop-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        FILTER +
                    </button>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card-box">
                            ...
                            <div class="card-text">
                                <p>Iluminating Serum</p>
                                <span class="price"> <span>$127</span> $95 </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
